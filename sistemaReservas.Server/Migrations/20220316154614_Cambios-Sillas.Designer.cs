...
namespace sistemaReservas.Server.Migrations
{
    ...
    [Migration("20220316154614_Cambios-Sillas")]
    partial class CambiosSillas
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sistemaReservas.Server.Models.TipoMesa", b =>
                {
                    b.Property<int>("IdTipoMesa")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("sistemaReservas.Server.Models.Silla", b =>
                {
                    b.HasOne("sistemaReservas.Server.Models.Mesa", null)
                        .WithMany("Sillas")
                        .HasForeignKey("MesaIdMesa");
                });
